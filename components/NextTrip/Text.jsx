  ...
  return (
    <div>
      <div className="flex flex-col mt-16 xl:ml-[127px] font-poppins | lg:w-[55vw] | xl:w-[43vw]">
        <div className="mb-8">
          <p className="text-center xl:ml-0 xl:text-left lg:text-left lg:ml-8 xl:text-[18px] font-semibold text-[#5E6282] font-poppins">Easy and Fast</p>
          <h1 className="text-center md:text-3xl lg:text-left lg:ml-8 xl:text-left xl:ml-0 text-2xl xl:text-[50px] xl:font-bold xl:my-5 text-[#14183E] xl:leading-[64px] font-volk">Book your next trip {<br/>} in 3 easy steps</h1>
        </div>
